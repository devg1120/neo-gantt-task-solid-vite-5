...
export const ganttDateRange = (tasks: Task[], viewMode: ViewModeEnum, preStepsCount: number) => {
...
export const seedDates = (startDate: Date, endDate: Date, viewMode: ViewModeEnum) => {
