...
export const Tooltip: Component<TooltipProps> = ({
  ...
  createEffect(() => {
    if (tooltipRef) {
      let task = __ganttEvent().changedTask
      const tooltipHeight = tooltipRef.offsetHeight * 1.1
      const tooltipWidth = tooltipRef.offsetWidth * 1.1
  ...
  return (
    <div
      ref={tooltipRef}
      class={relatedX() ? styles.tooltipDetailsContainer : styles.tooltipDetailsContainerHidden}
